...
<head>
    ...
    <title>Your Account is Active - Thinker HUB</title>
</head>
                    ...
                    <tr>
                        <td style="padding:12px 32px;">
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#f8fafc;border:1px solid #e2e8f0;border-radius:12px;border-collapse:separate;">
                                <tr>
                                    <td style="padding:14px 20px;border-bottom:1px solid #edf2f7;width:120px;font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:0.05em;color:#64748b;">
                                        Student Name
                                    </td>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:12px;">
                                <tr>
                                    <td style="padding:16px 20px;">
                                        ...
                                        <div style="font-size:13px;line-height:1.55;color:#14532d;">
                                            @if (! empty($student->firebase_uid))
                                                Click the button below to open the login page, then continue using your <strong>Google Account</strong>.
                                            @else
                                                Click the button below to sign in with your email address and password.
                                            @endif
                                        </div>
                                    </td>
                                </tr>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin:0 auto;">
                                <tr>
                                    <td style="border-radius:999px;background:#0a2d27;">
                                        <a href="{{ $actionUrl }}" style="display:inline-block;background-color:#0a2d27;color:#ffffff;text-decoration:none;font-size:14px;font-weight:700;padding:14px 32px;border-radius:999px;letter-spacing:0.02em;box-shadow:0 4px 6px -1px rgba(10,45,39,0.25);">
                                            {{ $actionLabel }} &rarr;
                                        </a>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td style="padding:20px 32px 24px;background-color:#f8fafc;border-top:1px solid #e2e8f0;">
                            <p style="margin:0;font-size:12px;line-height:1.6;color:#64748b;">
                                Need help getting started? Simply reply to this email or reach us at <a href="mailto:{{ config('mail.contact_to', 'thinkerhub@oristudiozm.com') }}" style="color:#0f766e;text-decoration:underline;">{{ config('mail.contact_to', 'thinkerhub@oristudiozm.com') }}</a>.
                            </p>
                        </td>
                    </tr>
