...
>
    ...
    {{-- Overlay container: backdrop + centered panel --}}
    <div
        x-show="open"
        x-cloak
        class="hub-notif-overlay"
    ...
    >
        <div class="hub-notif-panel" @click.stop>
            {{-- Close button (mobile only) --}}
            <div class="hub-notif-close-row">
                <button @click="open = false" type="button" style="background:none;border:none;cursor:pointer;color:var(--hub-muted);padding:0.25rem;">
