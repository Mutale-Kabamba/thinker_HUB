                ...
                <div
                    ...
                    x-data="{
                        handleNotificationClick(e) {
                            ...
                            window.dispatchEvent(new CustomEvent('markedNotificationAsRead', { detail: { id: '{{ $notification->id }}' } }));
                            window.dispatchEvent(new CustomEvent('notificationClosed', { detail: { id: '{{ $notification->id }}' } }));
                        }
                    }"
                    x-on:click="handleNotificationClick($event)"
                    @class([
