<div style="padding:0.85rem 1rem;background:var(--hub-surface);border-bottom:2px solid var(--hub-border);">
    ...
    @if (!empty($assessment['retake_allowed']))
        <div style="padding:0.5rem 0.75rem;background:#eff6ff;border:1px solid #bfdbfe;border-radius:6px;font-size:0.8rem;color:#1e40af;margin-bottom:0.6rem;">
            <strong>⭐ 2nd Chance Granted:</strong> Your instructor has granted you another chance to submit this assessment. (Recorded score capped at passing mark).
        </div>
    @endif
    @if (!empty($assessment['is_graded']))
        <div style="padding:0.5rem 0.75rem;background:#f0fdf4;border:1px solid #bbf7d0;border-radius:6px;font-size:0.8rem;color:#166534;margin-bottom:0.6rem;">
            <strong>Graded:</strong> This assessment has already been graded{{ ($assessment['score'] !== null && $assessment['score'] !== '-') ? ' (' . $assessment['score'] . '%)' : '' }}. Further submissions and changes are locked.
        </div>
