    ...
    <div class="hub-shell">
        <div class="hub-grid hub-grid-2">
            <section class="hub-card">
                ...
                <p class="hub-copy">Update your name, email address, and profile image without leaving Filament.</p>
                ...
                <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data" class="hub-stack" style="margin-top:0.8rem;">
                    ...
                    <div>
                        <label for="student_settings_name" class="hub-eyebrow">Name</label>
                        <input id="student_settings_name" name="name" type="text" value="{{ old('name', $user->name) }}" class="hub-input" required>
                        @error('name')
                    ...
                    <div>
                        <label for="student_settings_email" class="hub-eyebrow">Email</label>
                        <input id="student_settings_email" name="email" type="email" value="{{ old('email', $user->email) }}" class="hub-input" required>
                        @error('email')
                            <p class="hub-copy" style="color:var(--hub-danger);">{{ $message }}</p>
                        @enderror
                    </div>
        ...
        <div class="hub-grid hub-grid-2">
            <section class="hub-card">
                ...
                <form method="POST" action="{{ route('password.update') }}" class="hub-stack" style="margin-top:0.8rem;">
                    ...
                    <div>
                        <label for="student_current_password" class="hub-eyebrow">Current Password</label>
                        <input id="student_current_password" name="current_password" type="password" class="hub-input" autocomplete="current-password">
                    ...
                    <div>
                        <label for="student_new_password" class="hub-eyebrow">New Password</label>
                        <input id="student_new_password" name="password" type="password" class="hub-input" autocomplete="new-password">
                    ...
                    <div>
                        <label for="student_new_password_confirmation" class="hub-eyebrow">Confirm Password</label>
                        <input id="student_new_password_confirmation" name="password_confirmation" type="password" class="hub-input" autocomplete="new-password">
                    </div>
            ...
            <section class="hub-card">
                ...
                <p class="hub-copy">Deleting your account permanently removes your access and profile data.</p>
                ...
                <form method="POST" action="{{ route('profile.destroy') }}" class="hub-stack" style="margin-top:0.8rem;">
                    ...
                    <div>
                        <label for="student_delete_password" class="hub-eyebrow">Confirm Password</label>
                        <input id="student_delete_password" name="password" type="password" class="hub-input" autocomplete="current-password" required>
